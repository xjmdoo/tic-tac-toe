...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Field = __webpack_require__(300);
	...
	var Game = function () {
	    ...
	    _createClass(Game, [{
	        ...
	        value: function _loadFromLocalStorage() {
	            var _this = this;
	
	            var storage = window.localStorage.getItem('gameBoard');
	            var isGameInactive = window.localStorage.getItem('isGameInactive');
	            this._isGameInactive = isGameInactive === 'false' ? false : true;
	            if (storage !== null) {
	                if (!this._isGameInactive) {
	                    (function () {
	                        _this.state.fromString(storage);
	
	                        var cntX = 0;
	                        var cntO = 0;
	                        _this.state.board.forEach(function (field, index) {
	                            if (field.type === _Field2.default.TYPE.X) {
	                                cntX++;
	                                $('.ttt__field-inner[data-index="' + index + '"]').children('svg.lines').addClass('active');
	                            } else if (field.type === _Field2.default.TYPE.O) {
	                                cntO++;
	        ...
	        value: function _addEventListeners() {
	            ...
	            $('.ttt__field-inner').click(function () {
	                ...
	                if (self.state.board[index].type === _Field2.default.TYPE.EMPTY) {
	        ...
	        value: function _animateIn() {
	            ...
	            window.setTimeout(function () {
	                _this2.$board.addClass('active');
	            }, 400);
	        }
	    }, {
	        key: '_updateUIMove',
	        value: function _updateUIMove(player, index) {
	            if (player === _Field2.default.TYPE.X) {
	                $('.ttt__field-inner[data-index="' + index + '"]').children('svg.lines').addClass('active');
	            } else {
	                $('.ttt__field-inner[data-index="' + index + '"]').children('svg.circle').addClass('active');
	            }
	        ...
	        key: '_showPopup',
	        value: function _showPopup(text) {
	        ...
	        key: 'movePlayer',
	        value: function movePlayer(index) {
	            if (this._isGameInactive) return;
	            this._updateUIMove(_Field2.default.TYPE.X, index);
	            this.state.move(_Field2.default.TYPE.X, index);
	
	            this._updateLocalStorage();
	
	            if (this._isWinningPosition(_Field2.default.TYPE.X)) {
	        ...
	        value: function _computerMove() {
	            ...
	            if (this._isGameInactive) return;
	            var bestMove = this._minimax(_Field2.default.TYPE.O, 2);
	
	            window.setTimeout(function () {
	                _this3._updateUIMove(_Field2.default.TYPE.O, bestMove.index);
	                _this3.state.move(_Field2.default.TYPE.O, bestMove.index);
	
	                _this3._updateLocalStorage();
	
	                if (_this3._isWinningPosition(_Field2.default.TYPE.O)) {
	                    _this3._isGameInactive = true;
	                    _this3._showPopup('You have lost the game! :(');
	                    _this3._clearLocalStorage();
	                } else if (_this3.state.isGameOver()) {
	                    _this3._isGameInactive = true;
	                    _this3._showPopup('Draw!');
	                    _this3._clearLocalStorage();
	                }
	            }, 800);
	        }
	        ...
	        key: '_calcWinningLine',
	        value: function _calcWinningLine(line, player) {
	            var cnt = 0;
	        ...
	        key: '_isWinningPosition',
	        value: function _isWinningPosition(player) {
	            var sum = 0;
	        ...
	        key: '_minimax',
	        value: function _minimax(player, depth) {
	            var _this4 = this;
	            ...
	            if (this.state.isGameOver() || depth === 0) {
	                ...
	                this.state.board.forEach(function (field, index) {
	                    if (field.type === _Field2.default.TYPE.EMPTY) {
	
	                        if (player === _Field2.default.TYPE.X) {
	                            _this4.state.move(player, index);
	                            currentScore = _this4._minimax(_Field2.default.TYPE.O, depth - 1).value;
	                            ...
	                            _this4.state.move(player, index);
	                            currentScore = _this4._minimax(_Field2.default.TYPE.X, depth - 1).value;
	        ...
	        key: '_calcLine',
	        value: function _calcLine(lineArr) {
	            var numOfEmpty = 0;
	            var numOfX = 0;
	            var numOfO = 0;
	            var sum = 0;
	
	            lineArr.forEach(function (field, index) {
	                if (field.type === _Field2.default.TYPE.EMPTY) {
	                    numOfEmpty++;
	                } else if (field.type === _Field2.default.TYPE.X) {
	                    numOfX++;
	                } else {
	                    numOfO++;
	                }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameState = function () {
	    ...
	    _createClass(GameState, [{
	        key: '_createEmptyBoard',
	        value: function _createEmptyBoard() {
	            for (var i = 0; i < 9; i++) {
	                this._board.push(new _Field2.default(_Field2.default.TYPE.EMPTY));
	            }
	        }
	    }, {
	        key: 'move',
	        value: function move(player, index) {
	        ...
	        value: function isGameOver() {
	            for (var i = 0; i < this._board.length; i++) {
	                if (this._board[i].type === _Field2.default.TYPE.EMPTY) {
	                    return false;
	                }
	            }
	        ...
	        key: 'clearMove',
	        value: function clearMove(index) {
	            this._board[index].type = _Field2.default.TYPE.EMPTY;
	        }
	    }, {
	        key: 'resetBoard',
	        ...
	        value: function toString() {
	            var arr = [];
	            this._board.forEach(function (field) {
	                arr.push(field.type);
	            });
	        ...
	        value: function fromString(str) {
	            ...
	            this._board = [];
	            var gameStateArr = JSON.parse(str);
	            gameStateArr.forEach(function (field) {
	                _this.board.push(new _Field2.default(field));
	            });
	        }
	    }, {
	        key: 'board',
